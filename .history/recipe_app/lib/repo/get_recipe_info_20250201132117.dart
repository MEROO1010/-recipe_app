...
import 'package:recipe_app/api/api_key.dart';
  ...
  Future<List<dynamic>> getRecipeInfo(String id) async {
    ...
    if (response[0].statusCode == 200) {
      ...
      throw Failure(
        ...
        message: response[0].statusMessage!,
      );
    }
    if (response[1].statusCode == 200) {
      ...
      throw Failure(
        ...
        message: response[1].statusMessage!,
      );
    }
    if (response[2].statusCode == 200) {
      ...
      throw Failure(
        code: response[2].statusCode!,
        message: response[2].statusMessage!,
      );
    }
    if (response[3].statusCode == 200) {
      ...
      throw Failure(
        code: response[3].statusCode!,
        message: response[3].statusMessage!,
      );
    }

    return [racipeInfo, similarList, equipmentList, nutrients];
  }
}
