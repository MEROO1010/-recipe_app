...
import 'package:recipe_app/animation/animation.dart';
import 'package:recipe_app/models/food_type.dart';
import 'package:recipe_app/screens/home_screen/bloc/homerecipes_bloc.dart';
import 'package:recipe_app/screens/home_screen/widgets/food_type_widget.dart';
import 'package:recipe_app/screens/home_screen/widgets/horizonal_list.dart';
import 'package:recipe_app/screens/home_screen/widgets/list_items.dart';
import 'package:recipe_app/screens/recipe_info/bloc/recipe_info_bloc.dart';
import 'package:recipe_app/screens/recipe_info/bloc/recipe_info_screen.dart';
import 'package:recipe_app/screens/search_results/bloc/search_results_bloc.dart';
import 'package:recipe_app/screens/search_results/search_results_screen.dart';
        ...
        MaterialPageRoute(
          builder:
              (context) => BlocProvider(
                create: (context) => RecipeInfoBloc(),
                child: RecipeInfo(id: deepLink.queryParameters['id']!),
              ),
        ),
      );
    }
        ...
        body: BlocBuilder<HomeRecipesBloc, HomeRecipesState>(
          builder: (context, state) {
            if (state is HomeRecipesLoading) {
              ...
              return Center(child: Container(child: Text("Noting happingng")));
            }
          },
        ),
      ),
      ...
      child: ListView(
        ...
        children: [
          ...
          DelayedDisplay(
            ...
            child: FoodTypeWidget(items: widget.breakfast),
          ),
          Padding(
