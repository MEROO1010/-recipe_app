...
import 'package:recipe_app/screens/random_recipe/widgets/expandable.dart';
        ...
        body: ListView(
          children: [
            ...
            ExpandableGroup(
              ...
              items: const [
                ListTile(title: Text('App includes 5,000+ recipes.')),
                ListTile(title: Text('cost breakdown per servings.')),
                ListTile(title: Text('related recipes.')),
                ListTile(title: Text('Autocomplete search fetaure.')),
                ListTile(title: Text('Save recipes for letter.')),
                ListTile(title: Text('Get Random recipes.')),
                ListTile(title: Text('Everyday\'s meal plan with nutritions.')),
              ],
            ),
            ExpandableGroup(
              isExpanded: false,
              ...
              items: [
                ...
                ListTile(
                  ...
                  title: const Text(
                    'with open source spoonacular api',
