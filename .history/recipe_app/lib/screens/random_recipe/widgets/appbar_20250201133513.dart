...
import 'package:recipe_app/screens/random_recipe/widgets/favorite_button.dart';
...
class MySliverAppBar extends SliverPersistentHeaderDelegate {
  ...
  final Recipe info;
  MySliverAppBar({required this.expandedHeight, required this.info});
  @override
  Widget build(
  ...
  OverScrollHeaderStretchConfiguration get stretchConfiguration =>
      OverScrollHeaderStretchConfiguration(stretchTriggerOffset: maxExtent);
  @override
...
class _AppBarWidgetState extends State<AppBarWidget> {
  Future<Uri> data() async {
    ...
    final Uri dynamicUrl = await FirebaseDynamicLinks.instance.buildLink(
      parameters,
    );
    final ShortDynamicLink shortenedLink = await FirebaseDynamicLinks.instance
        .buildShortLink(
          dynamicUrl as DynamicLinkParameters,
      ...
      actions: [
        IconButton(
          onPressed: () async {
            ...
            Share.share('check out This tasty recipe $url');
          },
