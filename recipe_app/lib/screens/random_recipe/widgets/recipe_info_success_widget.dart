            ...
            child: Column(
              ...
              children: [
                        ...
                        children: [
                          ...
                          Flexible(
                            ...
                            child: Column(
                              children: [
                                Text(
                                  widget.info.pricePerServing.toString(),
                                  style: const TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 20,
                                  ),
                ...
                if (widget.info.extendedIngredients!.isNotEmpty)
                  DelayedDisplay(
                    delay: const Duration(microseconds: 600),
                    child: IngredientsWidget(recipe: widget.info),
                  ),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 20),
                        Html(data: widget.info.summary),
                      ],
                    ),
                  ),
                NutrientsWidgets(nutrient: widget.nutrient),
                NutrientsbadWidget(nutrient: widget.nutrient),
                NutrientsgoodWidget(nutrient: widget.nutrient),
                const SizedBox(height: 20),
