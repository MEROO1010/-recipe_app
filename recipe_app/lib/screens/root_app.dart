...
import 'package:recipe_app/screens/explore.dart';
...
class _RootAppState extends State<RootApp> with TickerProviderStateMixin {
  static const int animatedBodyMS = 300; // Define the constant here
  int _activeTabIndex = 1;
  final List _barItems = [
    {"icon": "assets/icons/search.svg", "page": const ExplorePage()},
    {"icon": "assets/icons/home.svg", "page": const HomePage()},
    {"icon": "assets/icons/bookmark.svg", "page": Container()},
  ];
  ...
  Widget _buildBottomBarPage() {
    return IndexedStack(
      ...
      children: List.generate(
        _barItems.length,
        (index) => _getAnimatedPage(_barItems[index]["page"]),
      ),
    );
  }
