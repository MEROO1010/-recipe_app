...
import 'package:recipe_app/screens/search_page/cubit/search_page_cubit.dart';
...
class SearchAutoCompleteTile extends StatefulWidget {
  ...
  const SearchAutoCompleteTile({Key? key, required this.list})
    : super(key: key);
              ...
              MaterialPageRoute(
                builder:
                    (context) => BlocProvider(
                      ...
                      child: RecipeInfo(id: widget.list.id),
                    ),
              ),
            );
          },
